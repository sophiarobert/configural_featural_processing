...
function prac_feedback_slowRoutineBegin(snapshot) {
  return function () {
    ...
    prac_feedback_slowComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function prac_feedback_fastRoutineBegin(snapshot) {
  return function () {
    ...
    prac_feedback_fastComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function end_prac_loopRoutineBegin(snapshot) {
  return function () {
    ...
    end_prac_loopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
